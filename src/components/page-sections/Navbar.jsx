...
export default function Navbar() {
    ...
    return (
        <nav className="fixed z-40 w-full px-2 lg:px-0 lg:mix-blend-exclusion lg:backdrop-blur-sm max-w-[2560px]">
            <div className="min-w-[250px] max-w-[420px] mx-auto rounded-full bg-black/50 backdrop-blur-sm px-3 py-2 mt-4 flex items-center justify-center lg:justify-between lg:bg-inherit lg:rounded-none lg:mt-0 lg:max-w-full">
                <div className="cursor-pointer bg-primary hidden lg:hover:bg-gradient lg:block ">
                ...
                <ul className="flex">
                    {links.map(({ id, link, icon }) => (
                        <li
                            key={id}
                            className={`relative z-50 text-primary text-xl px-3 py-3 mx-1 rounded-full cursor-pointer lg:hover:scale-110 duration-300 lg:hover:text-gradient md:mx-4 ${
